...
const providers = [
  ...
  },
  {
    ...
    icon: <ImageKitLogo size={34} className="rounded-sm" />,
    ...
    <section className="mx-auto w-full max-w-7xl border-x">
      <div className="flex flex-col items-center px-4 py-10 text-center sm:px-6 sm:py-12 lg:px-8">
        ...
        <p className="mt-3 max-w-xl text-pretty text-base leading-7 text-fd-muted-foreground sm:mt-4 sm:text-lg">
          Upload to AWS S3 or ImageKit today, with more provider adapters
          planned.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 divide-y border-t md:grid-cols-2 md:divide-x md:divide-y-0 lg:grid-cols-3">
        {providers.map((provider) => (
          ...
          >
            <div className="flex size-12 items-center justify-center rounded-md border bg-neutral-950 text-white shadow-sm sm:size-14">
              {provider.icon}
            </div>
        ...
        <div className="min-w-0 p-5 sm:p-6 md:col-span-2 md:border-t lg:col-span-1 lg:border-t-0 lg:p-8">
          <div className="flex size-12 items-center justify-center rounded-md border bg-fd-muted/50 text-fd-muted-foreground sm:size-14">
          ...
          <p className="mt-2 max-w-sm text-[15px] leading-6 text-fd-muted-foreground sm:text-base">
            Support for providers such as Cloudflare R2 and Cloudinary is
            planned.
          </p>
        </div>
      </div>
